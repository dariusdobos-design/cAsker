...
export const SERVICE_MAP_CARD_WIDTH = 270;
const CARD_WIDTH = SERVICE_MAP_CARD_WIDTH;
export const SERVICE_MAP_PIN_HEIGHT = 53;
const PIN_IMAGE = require("@/assets/icons/service-map-pin.png") as ImageSourcePropType;

if (Platform.OS === "android" && UIManager.setLayoutAnimationEnabledExperimental) {
  UIManager.setLayoutAnimationEnabledExperimental(true);
}

type ServiceMapSelectionCardProps = {
  service: MapServiceMarker;
  onClose: () => void;
  closeToken?: number;
  onContentChange?: () => void;
  /** Pin kreslí mapa pod kartou — overlay ho neduplikuje */
  showPin?: boolean;
};
...
export function ServiceMapSelectionCard({
  service,
  onClose,
  closeToken = 0,
  onContentChange,
  showPin = false,
}: ServiceMapSelectionCardProps) {
  ...
  return (
    <View style={styles.root}>
      ...
      {!showPin ? <View style={styles.cardTail} /> : null}

      {showPin ? (
        <Image source={PIN_IMAGE} style={styles.pin} resizeMode="contain" />
      ) : null}
