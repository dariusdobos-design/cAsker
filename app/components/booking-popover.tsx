...
function getSubmitErrorMessage(error: unknown) {
  ...
  if (message.includes("appointments_request_id_fkey")) {
    return "Dopyt sa nepodarilo prepojiť s termínom. Obnovte stránku a skúste znova.";
  }
  if (message.includes("row-level security") || message.includes("RLS")) {
    return "Chýba oprávnenie na uloženie do databázy. Spustite migráciu v Supabase.";
  }
  return message || "Termín sa nepodarilo uložiť.";
}
...
export function BookingPopover({
  ...
  useEffect(() => {
    ...
    setError(null);
    setSuccess(false);
    setAppointmentDate(toDateKey(new Date()));
      ...
      <form className="casker-booking-form" onSubmit={handleSubmit}>
        ...
        <label className="casker-booking-field">
          ...
          <textarea
            ...
            value={message}
            rows={3}
            placeholder="Termín servisu a správa pre zákazníka…"
        ...
        {success && (
          <p className="casker-booking-success">Termín odoslaný na schválenie.</p>
        )}
